...
----
. Wenn die Versionen nicht übereinstimmen, sollte das Betriebssystem aktualisiert werden. Siehe den Link:Siehe das link:https://community.mellanox.com/s/article/howto-upgrade-switch-os-software-on-mellanox-switch-systems["Mellanox Software-Upgrade-Leitfaden"^] für Details.
...
Führen Sie die Schritte zur Konfiguration des Ersatzschalters durch. Siehe Link:Siehe link:https://docs.mellanox.com/display/MLNXOSv381000/Configuration+Management["Mellanox-Konfigurationsmanagement"^] für Details.
