...
. [[Schritt 6]] Den Befehl „management node redeploy“ konfigurieren und ausführen, um eine Verbindung zu persistenten Volumes herzustellen, die auf dem Cluster gehostet werden, und Dienste mit den vorherigen Konfigurationsdaten des Management-Knotens zu starten:
+
