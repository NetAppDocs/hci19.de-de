...
Dieses Firmware-Paket wird auf Element Versionen 11.8, 12.0 und 12.2 unterstützt. Sie können die H610S BMC-Firmware direkt Out-of-Band aktualisieren, und Upgrade-Anweisungen finden Sie in  BMC firmware on H610S nodes.
