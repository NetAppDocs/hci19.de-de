...
* link:task_mnode_manage_storage_cluster_assets.html["Erstellen und Managen von Storage-Cluster-Assets"]
* link:task_mnode_remove_assets.html["Entfernen Sie ein Asset vom Management-Node"] *link:task_hcc_collectlogs.html#use-the-rest-api-to-collect-logs["VERWENDEN Sie die REST API zum Erfassen von Protokollen"]
